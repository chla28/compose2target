...
./bin/compose2target -i compose_samples/mariadb.yaml  -t ha -o vnrtmp/mariadb_ha.pcs
...
./bin/compose2target -i compose_samples/mariadb_mapping.yaml  -t ha -m mapping/mappingFile.yaml -o vnrtmp/mariadb_mapping_ha.pcs
